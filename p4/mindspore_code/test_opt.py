...
parser.add_argument('--mask_patch', type=int, default=21,
                    help='number of GPUs')
...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/share4/home/dataset',
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='../test',
                    help='demo image directory')
parser.add_argument('--data_train', type=str, default='DF2K',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='BSD100',
...
parser.add_argument('--sig', type=float, default=3.6,
...
parser.add_argument('--test_dir', type=str, default='/share4/home/benchmark',
                    help='dataset directory')
