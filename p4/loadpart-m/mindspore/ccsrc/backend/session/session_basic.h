...
class SessionBasic : public std::enable_shared_from_this<SessionBasic> {
 public:
  ...
  virtual void SetRuntimeResourceForFakeGraph(KernelGraphPtr target) { return; }
  virtual GraphId CompileGraphWithInferShape(NotNull<FuncGraphPtr> func_graph) { return kInvalidGraphId; } ;
