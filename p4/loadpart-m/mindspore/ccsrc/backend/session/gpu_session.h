...
class GPUSession : public SessionBasic {
 ...
 protected:
  ...
  // set runtime resource for target KernelGraph
  void SetRuntimeResourceForFakeGraph(KernelGraphPtr target) override;
  GraphId CompileGraphWithInferShape(NotNull<FuncGraphPtr> func_graph) override;
