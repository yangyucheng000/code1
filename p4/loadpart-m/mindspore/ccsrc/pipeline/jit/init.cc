...
#include "offloading/offloading_server_py.h"
#include "offloading/offloading_client_py.h"
#include "offloading/utils.h"
...
using BatchOffloadingServerPy = mindspore::offloading::BatchOffloadingServerPy;
using OffloadingClientPy = mindspore::offloading::OffloadingClientPy;
using OffloadingServerConfig = mindspore::offloading::OffloadingServerConfig;
using OffloadingClientConfig = mindspore::offloading::OffloadingClientConfig;
...
PYBIND11_MODULE(_c_expression, m) {
  ...
  (void)py::class_<OffloadingServerConfig, std::shared_ptr<OffloadingServerConfig>>(m, "OffloadingServerConfig_")
    .def(py::init())
    .def_readwrite("max_msg_mb_size", &OffloadingServerConfig::max_msg_mb_size)
    .def_readwrite("measure_interval", &OffloadingServerConfig::measure_interval)
    .def_readwrite("profile_times", &OffloadingServerConfig::profile_times)
    .def_readwrite("decompress_nthreads", &OffloadingServerConfig::decompress_nthreads)
    .def_readwrite("max_wait_time_ms", &OffloadingServerConfig::max_wait_time_ms)
    .def_readwrite("max_batch_size", &OffloadingServerConfig::max_batch_size)
    .def_readwrite("exec_mode", &OffloadingServerConfig::exec_mode)
    .def_readwrite("dequant_path", &OffloadingServerConfig::dequant_path)
    .def_readwrite("is_decompress", &OffloadingServerConfig::is_decompress)
    .def_readwrite("is_dequant", &OffloadingServerConfig::is_dequant)
    .def_readwrite("prep_full_graphs", &OffloadingServerConfig::prep_full_graphs)
    .def_readwrite("time_log", &OffloadingServerConfig::time_log)
    .def_readwrite("load_window_size", &OffloadingServerConfig::load_window_size);

  (void)py::class_<OffloadingClientConfig, std::shared_ptr<OffloadingClientConfig>>(m, "OffloadingClientConfig_")
    .def(py::init())
    .def_readwrite("max_msg_mb_size", &OffloadingClientConfig::max_msg_mb_size)
    .def_readwrite("bandwidth_window_size", &OffloadingClientConfig::bandwidth_window_size)
    .def_readwrite("load_window_size", &OffloadingClientConfig::load_window_size)
    .def_readwrite("measure_interval", &OffloadingClientConfig::measure_interval)
    .def_readwrite("profile_times", &OffloadingClientConfig::profile_times)
    .def_readwrite("is_static", &OffloadingClientConfig::is_static)
    .def_readwrite("load_control", &OffloadingClientConfig::load_control)
    .def_readwrite("passive_measure", &OffloadingClientConfig::passive_measure)
    .def_readwrite("compress_clevel", &OffloadingClientConfig::compress_clevel)
    .def_readwrite("compress_do_shuffle", &OffloadingClientConfig::compress_do_shuffle)
    .def_readwrite("compress_nthreads", &OffloadingClientConfig::compress_nthreads)
    .def_readwrite("compressor", &OffloadingClientConfig::compressor)
    .def_readwrite("quant_path_prefix", &OffloadingClientConfig::quant_path_prefix)
    .def_readwrite("is_compress", &OffloadingClientConfig::is_compress)
    .def_readwrite("is_quant", &OffloadingClientConfig::is_quant)
    .def_readwrite("local_deploy", &OffloadingClientConfig::local_deploy)
    .def_readwrite("profile_scale_factor", &OffloadingClientConfig::profile_scale_factor)
    .def_readwrite("oracle_bdw", &OffloadingClientConfig::oracle_bdw);

  (void)py::class_<BatchOffloadingServerPy, std::shared_ptr<BatchOffloadingServerPy>>(m, "BatchOffloadingServer_")
    .def(py::init())
    .def("start_grpc_server", &BatchOffloadingServerPy::StartGrpcServer)
    .def("stop", &BatchOffloadingServerPy::Stop);
  
  (void)py::class_<OffloadingClientPy, std::shared_ptr<OffloadingClientPy>>(m, "OffloadingClient_")
    .def(py::init())
    .def("start_grpc_client", &OffloadingClientPy::StartGrpcClient)
    .def("clear", &OffloadingClientPy::Clear)
    .def("stop", &OffloadingClientPy::Stop)
    .def("predict", &OffloadingClientPy::Predict)
    .def("predict_oracle", &OffloadingClientPy::PredictOracle)
    .def("static_predict_test", &OffloadingClientPy::StaticPredictTest)
    .def("print_cnode_order", &OffloadingClientPy::PrintCNodeOrder)
    .def("deploy", &OffloadingClientPy::Deploy)
    .def("profile", &OffloadingClientPy::Profile)
    .def("partition_decision_test", &OffloadingClientPy::PartitionDecisionTest)
    .def("fake_deploy", &OffloadingClientPy::FakeDeploy)
    .def("fake_static_predict_test", &OffloadingClientPy::FakeStaticPredictTest)
    .def("partial_execute", &OffloadingClientPy::PartialExecute)
    .def("convert_proto_tensor_from_file", &OffloadingClientPy::ConvertProtoTensorFromFile)
    .def("unit_test", &OffloadingClientPy::UnitTest);
}
